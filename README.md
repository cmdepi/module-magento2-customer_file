...
This little development allows you to implement the incorporation of a customer file attribute (with its respective file uploader) in an easy way.
...
In order to find documentation on the use and related issues, visit the [official page](https://binacommerce.com/customer-file.html) of this development.
